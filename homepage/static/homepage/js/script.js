...
// wrapCarousel({
//     container: '#carousel',
//     dataFileURI: '/static/homepage/js/data.json',
//     imgsDirURI: '/static/homepage/img'
// });
...
//         // else
//         //   location.href = slidesData[li.id.match(/\d+$/)].linkURL; // cancelado para que no abriera links al click
//     });
